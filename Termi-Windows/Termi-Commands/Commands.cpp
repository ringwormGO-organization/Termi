...
void __cdecl base64(const std::vector<std::string>& vect)
{
    if (vect.size() < 3)
    {
...
void __cdecl calc(const std::vector<std::string>& vect)
{
    if (vect.size() < 4)
    {
        AddLog("Not enough arguments!");
...
void __cdecl cd(const std::vector<std::string>& vect)
{
    if (vect.size() < 2)
    {
        AddLog("Not enough arguments!");
    ...
    Status(_chdir(vect[1].c_str()));
}

void __cdecl change_setting(const std::vector<std::string>& vect)
{
    if (vect.size() < 3)
    {
        AddLog("Not enough arguments!");
    ...
    try
    {
        ...
        {
            LoadDLL(setting, stof(vect[2]));
        }

        else if (setting == 5)
        {
            LoadDLL("SetFontName", vect[2].c_str());
            LoadDLL(5, 0);
        }

        else if (setting == 8)
        {
            LoadDLL("SetStartupCommand", vect[2].c_str());
            LoadDLL(8, 0);
        }
    }
...
void __cdecl echo(const std::vector<std::string>& vect)
{
    if (vect.size() < 2)
    {
        AddLog("Not enough arguments!");
...
void __cdecl find_command(const std::vector<std::string>& vect)
{
...
void __cdecl geocalc(const std::vector<std::string>& vect)
{
    if (vect.size() < 5)
    {
        AddLog("Not enough arguments!");
...
void __cdecl list_dir(const std::vector<std::string>& vect)
{
    struct dirent* d;
    struct stat dst;
...
void __cdecl new_dir(const std::vector<std::string>& vect)
{
    if (vect.size() < 2)
    {
        AddLog("Not enough arguments!");
...
void __cdecl sysfetch(const std::vector<std::string>& vect)
{
...
void __cdecl openfile(std::vector<std::string>& vect)
{
    fstream my_file;
    string file = vect[1];
...
void __cdecl ping(const std::vector<std::string>& vect)
{
    Status(2);
    return;
}

void __cdecl rm(const std::vector<std::string>& vect)
{
    if (vect.size() < 2)
    {
        AddLog("Not enough arguments!");
...
void __cdecl ttime(const std::vector<std::string>& vect)
{
...
void __cdecl whoami(const std::vector<std::string>& vect)
{
    TCHAR username[UNLEN + 1];
    DWORD username_len = UNLEN + 1;
    GetUserName((TCHAR*)username, &username_len);;
...
void __cdecl writefile(const std::vector<std::string>& vect)
{
    if (vect.size() < 3)
    {
        AddLog("Not enough arguments!");
...
void __cdecl yes(const std::vector<std::string>& vect)
{
    /*while (true)
    {
        AddLog("yes\n");
